 ...
 * @purpose This class extends on a abstract class Helpers and overrides all of its method
...
public class FieldHelper extends Helpers {
    ...
    /**
     * @param firstTv  TextView to change the value of edit field
     * @param secondTv TextView to change the value of edit field
     * @param thirdTv  TextView to change the value of edit field
     * @param params   String parameters to validate what's inside the edit field
     */
    @Override
    public void changeTextField(final TextView firstTv, final TextView secondTv, final TextView thirdTv, final String... params) {
     ...
     * @param secondTv TextView to change the value of edit field
     * @param thirdTv  TextView to change the value of edit field
     * @param fourthTv TextView to change the value of edit field
     * @param fifthTv  TextView to change the value of edit field
     * @param params   String parameters to validate what's inside the edit field
     */
    @Override
    ...
    /**
     * @param fieldName array list to set editable false
     */
    @Override
    ...
    /**
     * @param fieldName array list to set editable true
     */
    @Override
