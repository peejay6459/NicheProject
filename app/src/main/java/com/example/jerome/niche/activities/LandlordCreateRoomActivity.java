        ...
        btnAddProperty.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(validateFields(tvPropertyTitle, tvFlatStreet, tvSuburb)){
                    ...
                    InsertProperty ip = new InsertProperty(LandlordCreateRoomActivity.this);
                    ip.execute(Settings.URL_ADDRESS_INSERT_PROPERTIES);
                    Toast.makeText(LandlordCreateRoomActivity.this, "Property Created Successfully", Toast.LENGTH_SHORT).show();
                    Intent goBackManageProperties = new Intent(LandlordCreateRoomActivity.this, LandlordManagePropertiesActivity.class);
                    LandlordCreateRoomActivity.this.startActivity(goBackManageProperties);
                }
            }
        });
    }
    ...
    public boolean validateFields(TextView... tv){
        ...
        if(!(tv[0].getText().toString().isEmpty())
            ...
            if(!(tv[1].getText().toString().contains(",")) && !(tv[2].getText().toString().contains(","))) {
                ...
                Toast.makeText(LandlordCreateRoomActivity.this, "Please remove the comma (,)", Toast.LENGTH_SHORT).show();
                isValidated = false;
            }
        }else{
            Toast.makeText(LandlordCreateRoomActivity.this, "Please fill out the required forms", Toast.LENGTH_SHORT).show();
        }
        return isValidated;
    }
}